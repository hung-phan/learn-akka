...
object Mailboxes extends App {
  ...
  val supportTicketLogger = system.actorOf(Props[SimpleActor].withDispatcher("support-ticket-dispatcher"), "support-ticket-logger")
  ...
  val controlAwareActor = system.actorOf(Props[SimpleActor].withMailbox("control-mailbox"), "control-aware-actor")
  ...
  val altControlAwareActor = system.actorOf(Props[SimpleActor], "alt-control-aware-actor")
