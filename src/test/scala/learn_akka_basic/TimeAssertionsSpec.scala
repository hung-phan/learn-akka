...
class TimeAssertionsSpec extends TestKit(ActorSystem("TimeAssertionsSpec", ConfigFactory.load().getConfig("specialTimeAssertionsConfig"))) with ImplicitSender with AnyWordSpecLike with BeforeAndAfterAll {
